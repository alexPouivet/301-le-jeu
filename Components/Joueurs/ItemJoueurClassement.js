...
export default class ItemJoueur extends React.Component {
  ...
  render() {
    ...
    return (
      ...
      <View key={index} style={[ ClassementJoueursStyles.classementJoueurItemContainer, theme ==="dark" ? ClassementJoueursStyles.classementJoueurItemContainerDarkTheme : ClassementJoueursStyles.classementJoueurItemContainerLightTheme ]}>
        ...
        <Text style={[ ClassementJoueursStyles.classementJoueurItemStatut, theme=== "dark" ? ClassementJoueursStyles.classementJoueurItemStatutDarkTheme : ClassementJoueursStyles.classementJoueurItemStatutLightTheme ]}>{statut}</Text>
      </View>
